...
class AutoMixup(BaseModel):
    ...
    *** Requiring Hook: `momentum_update` is adjusted by `CosineScheduleHook` after
    ...
    def forward_train(self, img, gt_label, **kwargs):
        ...
        # self.i += 1
        # if self.i % 327 == 0:
        #     test = self.save_mixed_sample()
        #     name = str(self.i // 327) + 'test.jpg'
        #     save_image(test, name)
    ...
    def save_mixed_sample(self):
        ...
        results = self.pixel_mixup(imgs, lables, [0.5, 0.5], indices, feature)
